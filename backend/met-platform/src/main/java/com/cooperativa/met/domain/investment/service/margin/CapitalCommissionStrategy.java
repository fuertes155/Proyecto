...
/**
 * Modelo C: Comisión_plataforma = Capital × m (no depende del interés generado).
 * Rendimiento_inversionista = Interés_generado - Comisión_plataforma.
 */
class CapitalCommissionStrategy implements MarginStrategy {

    @Override
    public MarginModel getModel() {
        return MarginModel.CAPITAL_COMMISSION;
    }
