...
@Converter
public class SearchableCryptoConverter implements AttributeConverter<String, String> {
    ...
    public String convertToDatabaseColumn(String attribute) {
        ...
        return AesEncryptionAdapter.INSTANCE.encryptDeterministic(attribute);
    }
    ...
    public String convertToEntityAttribute(String dbData) {
        ...
        return AesEncryptionAdapter.INSTANCE.decryptDeterministic(dbData);
    }
}
