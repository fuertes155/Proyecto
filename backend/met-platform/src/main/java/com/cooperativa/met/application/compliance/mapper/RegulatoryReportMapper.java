package com.cooperativa.met.application.compliance.mapper;
...
public class RegulatoryReportMapper {
    ...
    public RegulatoryReportResponse toResponse(RegulatoryReport report) {
        String downloadUrl = report.getStatus() == com.cooperativa.met.domain.compliance.model.ReportStatus.COMPLETED
